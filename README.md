...
![Last test](https://github.com/andrelohmann/ansible-role-minio/actions/workflows/test.yml/badge.svg)

## Content

Install minio from binary packages.
